...
//            this.insertContentAtGridPosition(1, 0, this.heartRateData.activityHeartRateReserve.toFixed(0), 'Average HRR', '%', 'displayAdvancedHrData');
//            this.insertContentAtGridPosition(2, 0, this.heartRateData.TRIMPPerHour.toFixed(0), 'TRIMP/Hour', '', 'displayAdvancedHrData');

            this.insertContentAtGridPosition(1, 1, this.heartRateData.averageHeartRate.toFixed(0), 'Average Heart Rate', 'bpm', 'displayAdvancedHrData'); // Usefull for running
